...
SECRET_KEY = 'django-insecure-yodr8v6fa0&-lwshxs=f@))y%4qzh*6&rw(rkzltzw&w#$rq8z'
...
MIDDLEWARE = [
    'core.middlewares.ValidateAuthTokenMiddleware',
...
DATABASES = {
    "default": {
        ...
        "NAME": environ.get("POSTGRES_DATABASE", "promo"),
